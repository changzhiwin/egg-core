...
class EggLoader {
     ...
     * 对于继承EggCore的子类，依次向上加载直到到达EggCore本身
    ...
    loadFile(filepath, ...inject) {
        ...
        if (is.function(ret) && !is.class(ret)) {
            ret = ret(...inject); // 如果是个function，就执行
        }
        return ret;
    }
    ...
    loadToContext(directory, property, opt) {
        console.log('---- Call loadToContext')
        opt = Object.assign({}, {
            directory,
            property,
            inject: this.app,
