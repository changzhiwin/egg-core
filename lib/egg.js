...
// egg 本身也是继承这个class，这是架子的本质，大部分约定的内容，这里定型
class EggCore extends KoaApplication {
    ...
    constructor(options = {}) {
         ...
         * @since 1.0.0
         */
        this.console = new EggConsoleLogger({level:'WARN'});
        ...
        // Lifecycle 是 EventEmitter的继承，mixin了getReady库 
    ...
    // 这个操作很骚，相当于这个loader是默认的；后面的子类会覆盖EGG_LOADER这个key，例如agent/application都覆盖了
    get[EGG_LOADER]() {
